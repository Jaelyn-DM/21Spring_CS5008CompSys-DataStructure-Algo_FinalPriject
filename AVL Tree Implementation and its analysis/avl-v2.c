...
int main(){
    ...
    printf("\nTesting insertion from 1 to 10000...\n");
    for (int i = 0; i < 10; i++) {
        testInsert1();
    }
    printf("\nTesting insertion from 10000 to 1...\n");
    for (int i = 0; i < 10; i++) {
        testInsert2();
    }

    // printf("\nTesting insertion for random 10000 numbers...\n");
    // for (int i = 0; i < 10; i++) {
    //     testInsert3();
    // }

    printf("\nTesting search for 1000 times...\n");
    for (int i = 0; i < 10; i++) {
        testSearch();
    }
}